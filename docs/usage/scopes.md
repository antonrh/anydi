...
The fresh context has its own instances. It still resolves parent and `singleton` dependencies, but inherits nothing from the context it shadows, and on exit only its own resources are closed.
